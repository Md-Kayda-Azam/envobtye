    ...
    <footer className="bg-[#001243] text-white pt-10 pb-5">
      <div className="w-full mx-auto px-4">
        ...
        <div className="flex justify-between items-center lg:flex-row flex-col gap-5 lg:gap-0">
          ...
          <div className="w-full lg:w-auto flex justify-center flex-col items-start">
            <div className="mb-4">
              <Image src={Logo} alt="LOGO" height={30} width={117} />
            </div>
            <p className="w-[225px] text-sm md:text-base font-normal md:leading-6 text-gray-300 font-roboto tracking-normal">
              We are an IT Company. We help businesses by bringing ideas to life
              easily & affordably.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-0 md:grid-cols-4 w-full lg:w-auto">
            {/* Column 2: Company */}
            <div>
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-4">
                <Link target="_blank" href="https://www.facebook.com/envobyte">
                  <div className="">
                    <Image
                      src={Facebook}
                      alt="Facebook"
                ...
                <Link target="_blank" href="https://x.com/envobyte">
                  <div className="">
                    <Image
                      src={X}
                      alt="X"
                ...
                <Link
                  target="_blank"
                  href="https://www.pinterest.com/envobyte/"
                >
                  <div className="">
                    <Image
                      src={Pinterest}
